...
`;
        ...
        return (
            <div className="h-screen w-full bg-slate-50 flex flex-col font-light">
                ...
                <div className="shrink-0 z-10 sticky top-0 bg-white/70">
                    <div className="bg-white/70 backdrop-blur-md flex items-end pb-3 px-4 border-b border-white/40 h-20" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
    ...
    return (
        <div className="h-full w-full bg-[#f0f4f8] flex flex-col font-sans relative">
            ...
            <div className="bg-white/80 backdrop-blur-xl px-5 flex items-end pb-4 border-b border-slate-200/60 shadow-sm h-24" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
                {selectionMode ? (
                    ...
                    <div className="flex items-center gap-3 w-full">
                        <button onClick={() => setView('list')} className="p-2 rounded-full hover:bg-slate-100 active:bg-slate-200 transition-colors">
