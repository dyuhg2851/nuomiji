...
`;
    ...
    if (mode === 'calendar' && selectedChar) {
        return (
            <div className="h-full w-full bg-white flex flex-col font-light relative">
                {introModal}
                {archiveResultModal}
                <div className="pt-8 pb-6 px-6 bg-amber-500 shadow-lg shrink-0 rounded-b-[2rem] z-20">
    ...
    return (
        <div className="h-full w-full bg-[#1a1a1a] flex flex-col relative overflow-hidden">
            ...
            {/* Editor Header */}
            <div className="pt-8 pb-3 px-4 bg-[#1a1a1a]/90 backdrop-blur-md flex items-center justify-between text-white shrink-0 z-30 h-20 box-border">
                <button onClick={() => setMode('calendar')} className="p-2 text-white/60 hover:text-white rounded-full active:bg-white/10 transition-colors">
