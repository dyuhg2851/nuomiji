       ...
       {view === 'list' ? (
           <div className="flex flex-col h-full animate-fade-in">
               ...
               <div className="shrink-0 z-10 sticky top-0">
                   <div className="px-6 pt-4 pb-4 shrink-0 flex items-center justify-between backdrop-blur-md" style={{ paddingTop: 'calc(16px + env(safe-area-inset-top, 0px))' }}>
           ...
           <div className="flex flex-col h-full animate-fade-in bg-slate-50/50 relative">
               ...
               <div className="shrink-0 z-40 sticky top-0 bg-gradient-to-b from-white/90 to-white/60">
                   <div className="h-32 bg-gradient-to-b from-white/90 to-transparent backdrop-blur-sm flex flex-col justify-end px-5 pb-2 shrink-0" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
