...
4. 顶栏顶部已自动留出状态栏安全区。装饰若要贴最顶部，用 top: calc(env(safe-area-inset-top, 0px) + 数值)。
...
.sully-chat-header::before{
  ...
  top:calc(env(safe-area-inset-top, 0px) + 4px) !important;right:14px !important;
...
.sully-chat-header::before{
  content:"";position:absolute;left:.6rem;right:.6rem;top:calc(env(safe-area-inset-top, 0px) + .1rem);height:2.6rem;pointer-events:none;z-index:0;
  background:
